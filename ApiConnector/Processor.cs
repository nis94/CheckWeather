...
namespace ApiConnector
{
    public static class Processor
    {
        ...
        {
            string URL = string.Format("https://api.openweathermap.org/data/2.5/onecall?lat={0}&lon={1}&units={2}&exclude={3}&appid={4}",
                lat.ToString(), lon.ToString(), "metric", "daily", APIKey);
